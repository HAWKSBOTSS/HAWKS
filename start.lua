...
print("::Black::")
local RunBot = io.open("HAWSKBOTSS", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/HAWSKBOTSS
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr HAWSKBOTSS.lua
wget "https://raw.githubusercontent.com/HAWSKBOTSS/HAWSKBOTSS/master/HAWSKBOTSS.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./HAWSKBOTSS.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S HAWSKBOTSS -X kill
screen -S HAWSKBOTSS ./HAWSKBOTSS
done
]])
RunTs:close()
end
